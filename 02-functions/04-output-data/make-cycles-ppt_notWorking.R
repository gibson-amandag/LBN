...
#'   
#'   ## This gives the whole list of values
#'   # if(!is.na(maxLH)){
#'   #   maxLHLabel <- paste0(maxLH, " ng/mL - ", trt)
#'   # }else {
#'   #   maxLHLabel <- ""
#'   # }
#'   
#'   
#'   maxLHLabel <- ifelse(!is.na(maxLH), paste0(maxLH, " ng/mL - ", trt), "") ## always giving the same treatment
#'   print(paste0("maxLHLabel: ", maxLHLabel))
...
#' #   print(paste("startCycleDay_pres", samplingDF$startCycleDay_pres))
#' #   
#' #   # createSamplingSlide(
#' #   #   "mouseID",
#' #   #   "cycleID",
...
#' #     amImgPath = NA,
#' #     prevDayImgPath = NA,
#' #     twoDayPrevImgPath = NA,
#' #     uterinePicPath = NA,
#' #     startCycleDay_pres = NA,
#' #     endCycleDay_pres = NA
#' #   )
#' # }
#' addSamplingSlidesFromDF <- function(
