...
```{r}
Maturation_off_litter1_females <- Maturation_off %>%
  filter(
    Litter_num == 1,
    Cohort == 2,
    sex == "F"
  )
Maturation_off_litter1_males <- Maturation_off %>%
  filter(
    Litter_num == 1,
    Cohort ==2,
    sex == "M"
...
df_females <- Maturation_off_litter1_females
df_males <- Maturation_off_litter1_males
```
## Maturation
...
Estrus_mass_plot <- Maturation_off_litter1_females %>%
...
grantPlot <- plot_grid(
  ...
  nrow = 1,
  rel_widths = c(0.5, 0.07, 0.5, 0.05, 1)
)
ggsave(
  file.path(plotOutputFolder, paste0(filePrefix, "NRSA_plot_litter1_small2.pdf")),
  plot = grantPlot,
  device = "pdf",
  width = 5,
  height = 0.95,
...
# ggsave(
#   file.path(plotOutputFolder, paste0(filePrefix, "NRSA_plot_litter1.png")),
#   plot = grantPlot,
#   device = "png",
#   width = 5.6,
#   height = 1.45,
