...
figCortLogA <- cortFilteredMales %>%
  ...
  scale_y_continuous(trans = "log"
                     , limits = c(NA, 400)
                     , breaks = c(0, 6.25, 12.5, 25, 50, 100, 200, 400)
                     , labels = c(0, "6.25", "12.5", "25", "50", "100", "200", "400")) +
  plotError_LMM_aes(
    cort_lmm_error %>%
      filter(
        hormoneStatus == "male"
...
LBN males are smaller than STD males. No difference for either female group
...
Males are smaller than both female groups, trend at this point for proestrus to be larger than diestrus
