...
```{r}
get_year(as_date("2022-04-01"))
myTime <- as_date_time(as_date("2022-03-13"), "America/New_York")
zoned_time_parse_abbrev(myTime, "America/New_York")

as.POSIXct(as_date("2022-03-13"), "America/New_York")
...
breeding_cohort9 <- Demo_dam %>%
  filter(
    breedDate > as_date("2022-10-01")
    , is.na(DOB) | DOB > as_date("2022-10-30")
  ) %>%
  select(
    damID
    , breedDate
  ...
  mutate(
    PND4 = as_date(ifelse(!is.na(DOB), DOB + 4, DOB_est + 4))
    , PND11 = as_date(ifelse(!is.na(DOB), DOB + 11, DOB_est + 11))
    , PND21 = as_date(ifelse(!is.na(DOB), DOB + 21, DOB_est + 21))
    , PND70 = as_date(ifelse(!is.na(DOB), DOB + 70, DOB_est + 70))
    , PND91 = as_date(ifelse(!is.na(DOB), DOB + 91, DOB_est + 91))
  )
...
breeding_cohort9 <- Demo_dam %>%
  filter(
    cohort == 9 | breedDate > as_date("2023-03-01")
  ...
  mutate(
    ...
    , PND11 = as_date(ifelse(!is.na(DOB), DOB + 11, DOB_est + 11))
    , PND21 = as_date(ifelse(!is.na(DOB), DOB + 21, DOB_est + 21))
    , PND35 = as_date(ifelse(!is.na(DOB), DOB + 35, DOB_est + 35))
    , PND49 = as_date(ifelse(!is.na(DOB), DOB + 49, DOB_est + 49))
    , PND63 = as_date(ifelse(!is.na(DOB), DOB + 63, DOB_est + 63))
    , PND70 = as_date(ifelse(!is.na(DOB), DOB + 70, DOB_est + 70))
    , PND91 = as_date(ifelse(!is.na(DOB), DOB + 91, DOB_est + 91))
    , .after = DOB
  ) %>%
...
availMales <- LBN_data %>%
  ...
  mutate(
    ageJuly14 = as_date("2023-07-14") - DOB
  )
...
litters_cohort10 <- Demo_dam %>%
  ...
  mutate(
    ...
    , PND70 = as_date(ifelse(!is.na(DOB), DOB + 70, DOB_est + 70))
    , PND91 = as_date(ifelse(!is.na(DOB), DOB + 91, DOB_est + 91))
    , PND120 = as_date(ifelse(!is.na(DOB), DOB + 120, DOB_est + 120))
    , .after = DOB
  ) %>% left_join(
    Demo_off %>%
      filter(
